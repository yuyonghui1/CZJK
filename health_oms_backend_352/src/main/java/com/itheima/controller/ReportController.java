...
public class ReportController {
    ...
    public Result getAge(){
        try {
            ...
            Map<String,Object> map = memberService.getAge();
            return new Result(true,"成了",map);
   ...
   public Result finAllSex(){

         try{


             List<Map<String,Object>> setmealCount = memberService.getSex();
             System.out.println("setmealCount = " + setmealCount);
//              2
             List<Map<String,Object>> setmealCount2 = memberService.getSex2();
             List<Map<String,Object>>  setmealCunt=new ArrayList<Map<String,Object>>();
             ...
             for (Map<String, Object> map : setmealCount2) {
                 String name = String.valueOf(map.get("name"));
                 if ( "2".equals(name)){
                     map.put("name","男");
                 }else {
             ...
             setmealCunt.addAll(setmealCount);
             setmealCunt.addAll(setmealCount2);
              // 所有的name
             ...
             resultMap.put("setmealCount",setmealCunt);
